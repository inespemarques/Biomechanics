...
elseif strcmp(file,'climber')
    % Define data
    Data.nframes=xlsread(file_xls ,1,'B1');
    Data.fs=xlsread(file_xls ,1,'B4');
    Data.coordinates=xlsread(file_xls ,1,'C12:BG3630'); 
    Data.tstep=xlsread(file_xls ,1,'B13')-xlsread(file_xls ,1,'B12');
    Data.tend=xlsread(file_xls ,1,'B3630')-xlsread(file_xls ,1,'B12');
...
elseif strcmp(file,'climbercycle')
    ...
    Data.nframes=370;
    Data.fs=xlsread(file_xls ,1,'B4');
    Data.coordinates=xlsread(file_xls ,1,'C12:BG383'); 
    Data.tstep=xlsread(file_xls ,1,'B13')-xlsread(file_xls ,1,'B12');
    Data.tend=xlsread(file_xls ,1,'B383')-xlsread(file_xls ,1,'B12');
end
